...
## Aggiornamento Finale (2026-05-05 - backup chiusura)

- Prima della chiusura su `main`, richiesto overwrite dell'ultimo backup locale.
- Policy Git invariata: gli archivi in `backup/` restano ignorati e non vanno committati.
- Il backup sovrascritto deve contenere:
  - hardening responsive mobile;
  - fix IBAN wrappabile;
  - aggiornamenti RSVP copy/Under18/assenza;
  - rimozione tastierino custom PIN admin;

...
## Aggiornamento Finale (2026-05-05 - chiusura UX mobile)

- App pubblica consolidata per uso mobile reale Android/iOS:
  - IBAN non deborda piu nei box Programma/Regalo;
  - modali scrollabili e safe-area aware;
  - CTA, riepiloghi e righe decorative resi adattivi su viewport stretti.
- RSVP:
  - naming visibile `Under18` uniformato;
  - select ospiti ridotti a valori numerici;
  - messaggio conferma semplificato mantenendo totale corretto;
  - annullamento assenza torna alla Home.
- Admin:
  - rimosso tastierino custom dal modale PIN;
  - accesso affidato al campo PIN con tastiera nativa mobile.
- Nessuna modifica a persistenza, Supabase, schema DB o Google Sheet backup.

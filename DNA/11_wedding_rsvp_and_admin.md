...
## Aggiornamento Operativo (2026-05-04 - campanella admin resiliente)

- Campanella admin ora affidabile anche in scenari mobile iOS con sospensione background.
- Notifiche nuove RSVP calcolate tramite differenza tra record correnti e set "gia letti".
- Tap campanella mantiene comportamento canonico: marca come lette e reset badge.

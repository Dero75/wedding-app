...
## Aggiornamento Operativo (2026-05-04 - notification reliability iOS)

- Hardening notifiche admin completato su `Admin.tsx`.
- Introduzione strategia di conteggio "unread by id" per evitare perdita eventi realtime in background iOS.
- Sync difensiva su eventi `visibilitychange`/`focus` per recupero nuovi RSVP in rientro app.
- Nessuna modifica a business logic RSVP, layout o UX visuale.

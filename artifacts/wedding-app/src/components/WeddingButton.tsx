...
export default function WeddingButton({
  ...
  const base =
    "inline-flex max-w-full items-center justify-center px-6 py-3.5 text-center font-sans text-xs leading-tight tracking-wider uppercase rounded-full transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring active:scale-[0.97] select-none";
